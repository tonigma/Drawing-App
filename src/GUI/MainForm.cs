...
namespace Draw
{
	...
	public partial class MainForm : Form
	{
        ...
        private void nameButton_Click(object sender, EventArgs e)
        {
            ...
            dialogProcessor.SetName(name);
            statusBar.Items[0].Text = "Последно действие: Именуване не примитив";
            viewPort.Invalidate();
        }
        ...
        private void cloackToolStripMenuItem_Click(object sender, EventArgs e)
        {
            dialogProcessor.AddRandomClock();

            statusBar.Items[0].Text = "Последно действие: Рисуване на часовник";
        ...
        {
            dialogProcessor.AddRandomTrapez();
        ...
        private void RotateNumeric_ValueChanged(object sender, EventArgs e)
        {
            dialogProcessor.Rotate(float.Parse(RotateNumeric.Text));
            statusBar.Items[0].Text = "Последно действие: Завъртане";
            viewPort.Invalidate();
        }
        ...
        private void WidthNumeric_ValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!WidthNumeric.Text.Equals(""))
                {
                    width = float.Parse(WidthNumeric.Text);
                }
                else
                {
                    width = -1;
        ...
        private void HeightNumeric_ValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!HeightNumeric.Text.Equals(""))
                {
                    height = float.Parse(HeightNumeric.Text);
                }
                else
                {
                    height = -1;
