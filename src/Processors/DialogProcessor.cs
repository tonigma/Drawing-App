...
namespace Draw
{
	...
	public class DialogProcessor : DisplayProcessor
	{
        ...
        public void AddRandomTrapez()
        {
            Random rnd = new Random();
            int x = rnd.Next(100, 1000);
            int y = rnd.Next(100, 600);

            TrapecShape trapec = new TrapecShape(new Rectangle(x, y, 100, 200));

            trapec.FillColor = Color.White;
            trapec.BorderColor = Color.Black;
            trapec.Opacity = 255;
            trapec.BorderWidth = 1;

            ShapeList.Add(trapec);
        }
        ...
        public void AddRandomEllipsa()
        {
            ...
            ElipseShape elipse = new ElipseShape(new Rectangle(x, y, 300, 150));
        ...
        public void AddRandomClock()
        {
            ...
            ClockShape clo = new ClockShape(new Rectangle(x, y, 200, 100));
            clo.FillColor = Color.White;
            clo.BorderColor = Color.Black;
            clo.Opacity = 255;
        ...
        public void AddRandomLetter() 
        {
            ...
            LetterShape letter = new LetterShape(new RectangleF(x, y, 125, 75));
